...
public class MainScreenController implements Initializable,Controller {
    ...
    public MainScreenController()throws UnsupportedOperationException{
     ...
     */
    @FXML
    synchronized  void  handleModifyPart(ActionEvent event) throws IOException {
     ...
     */
    @FXML
    synchronized void  handleModifyProduct(ActionEvent event) throws IOException {
