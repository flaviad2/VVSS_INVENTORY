...
public class InventoryService {
    ...
    public void addInhousePart(String name, double price, int inStock, int min, int  max, int partDynamicValue) throws IOException {
    ...
    public void addOutsourcePart(String name, double price, int inStock, int min, int  max, String partDynamicValue) throws IOException {
    ...
    public void addProduct(String name, double price, int inStock, int min, int  max, ObservableList<Part> addParts) throws IOException {
    ...
    public void updateInhousePart(int partIndex, int partId, String name, double price, int inStock, int min, int max, int partDynamicValue) throws IOException {
    ...
    public void updateOutsourcedPart(int partIndex, int partId, String name, double price, int inStock, int min, int max, String partDynamicValue) throws IOException {
    ...
    public void updateProduct(int productIndex, int productId, String name, double price, int inStock, int min, int max, ObservableList<Part> addParts) throws IOException {
